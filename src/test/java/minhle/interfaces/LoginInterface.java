...
public class LoginInterface {
    ...
    public static final String BUTTON_QUAN_LY = "//button[contains(text(),'Quản lý')]";
    public static final String BUTTON_BAN_HANG = "//span[contains(text(),'Bán hàng')]";
}
